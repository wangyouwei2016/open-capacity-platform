...
angular.module("sentinelDashboardApp", ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog", "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard", "selectize", "angularUtils.directives.dirPagination"]).factory("AuthInterceptor", ["$window", "$state",
    function(r, t) {
        return {
            ...
            request: function(e) {
                var t = r.location.protocol + "//" + r.location.host;
                return e.url.startsWith("/") && (e.url = e.url.slice(1)), e.url = t + "/" + e.url, console.log(e.url), e
            },
...
]), (app = angular.module("sentinelDashboardApp")).filter("range", [
    function() {
        return function(e, t) {
    ...
    function(a) {
        ...
        this.queryMachineRules = function(e, t, r) {
            ...
            return a({
                url: "/v2/flow/rule/" + e.id + "?app=" + e.app,
                method: "DELETE"
            })
        }, this.checkRuleValid = function(e) {
            return void 0 === e.resource || "" === e.resource ? (alert("资源名称不能为空"), !1) : void 0 === e.count || e.count < 0 ? (alert("限流阈值必须大于等于 0"), !1) : void 0 === e.strategy || e.strategy < 0 ? (alert("无效的流控模式"), !1) : 1 != e.strategy && 2 != e.strategy || void 0 !== e.refResource && "" != e.refResource ? void 0 === e.controlBehavior || e.controlBehavior < 0 ? (alert("无效的流控整形方式"), !1) : 1 == e.controlBehavior && t(e.warmUpPeriodSec) ? (alert("预热时长必须大于 0"), !1) : 2 == e.controlBehavior && t(e.maxQueueingTimeMs) ? (alert("排队超时时间必须大于 0"), !1) : !e.clusterMode || void 0 !== e.clusterConfig && void 0 !== e.clusterConfig.thresholdType || (alert("集群限流配置不正确"), !1) : (alert("请填写关联资源或入口"), !1)
    ...
    function(a) {
        this.queryMachineRules = function(e, t, r) {
            ...
            return a({
                url: "/degrade/rule/" + e.id + "?app=" + e.app,
                method: "DELETE"
            })
        }, this.checkRuleValid = function(e) {
            ...
            if (void 0 !== e.statIntervalMs && 12e4 < e.statIntervalMs) return alert("统计窗口时长最大 120s"), !1;
    ...
    function(a) {
        ...
        this.queryMachineRules = function(e, t, r) {
            ...
            return a({
                url: "/paramFlow/rule/" + e.id + "?app=" + e.app,
                method: "DELETE"
            })
        }, this.checkRuleValid = function(e) {
    ...
    function(a) {
        this.queryMachineRules = function(e, t, r) {
            ...
            return a({
                url: "/authority/rule/" + e.id + "?app=" + e.app,
                method: "DELETE"
            })
        }, this.checkRuleValid = function(e) {
