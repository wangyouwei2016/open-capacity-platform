...
public abstract class AbstractFileService implements FileService {
	 ...
	 * @param fileInfo
	 */
	protected abstract void uploadBigFile(MultipartFile file, FileInfo fileInfo) throws Exception;
...
//	protected abstract void uploadError( String guid,String fileName,String filePath ) throws Exception;
	...
	/**
	 * 文件上传：判断文件大小如果超过100MB采用分段上传/断点续传
	 * @param file
	 * @return
	 * @throws Exception
	 */
	...
	public FileInfo upload(MultipartFile file  ) throws Exception {
		...
		//判断文件大小，大于100MB需要分段上传
		if (file.getSize() > (100*1024*1024L)){
			uploadBigFile(file,fileInfo);
		}else{
