    ...
    public OAuth2AccessToken getRefreshTokenInfo(String refresh_token, String clientId, String clientSecret) {
        try {
            ...
            AuthorizationServerTokenServices authorizationServerTokenServices =
                    SpringUtil.getBean("tokenServices", AuthorizationServerTokenServices.class);
            ...
            TokenRequest tokenRequest = new TokenRequest(map, clientDetails.getClientId(), clientDetails.getScope(), "refresh_token");
            OAuth2AccessToken oAuth2AccessToken = refreshTokenGranter.grant("refresh_token", tokenRequest);
            return oAuth2AccessToken;
        } catch (InvalidClientException e ) {
            throw new ServiceException(e);
        }catch (UnapprovedClientAuthenticationException e1){
