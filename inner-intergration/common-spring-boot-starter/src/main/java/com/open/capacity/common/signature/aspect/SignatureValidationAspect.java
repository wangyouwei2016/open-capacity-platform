package com.open.capacity.common.signature.aspect;
...
import com.open.capacity.common.exception.SignatrueValidationException;
...
public class SignatureValidationAspect {
     ...
     * 开始验签
     */
    @Before("@within(signatureValidation) || @annotation(signatureValidation)")
    public void doBasicProfiling(SignatureValidation signatureValidation ) {
